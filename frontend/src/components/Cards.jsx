    ...
    <section className="text-center py-16 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {cardData.map((card, i) => (
          ...
          >
            <div className="bg-white/80 backdrop-blur-md rounded-xl shadow-md p-6 h-64 flex flex-col justify-center items-center border-t-4 border-[#f7b733] hover:shadow-lg transition duration-300">
